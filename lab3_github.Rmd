...
Click on the pencil icon to insert the following:
...
Click **Create pull request**.  Let's give this pull request the title `Hello (main) <- Welcome (test-conflict)`.
...
So if we want to go with Welcome, reduce the lines above to simply:
